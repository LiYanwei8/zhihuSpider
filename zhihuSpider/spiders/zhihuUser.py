...
from zhihuSpider.items import  UserInfoItem, RelationItem
...
class ZhihuuserSpider(CrawlSpider):
    ...
    start_urls = ['https://www.zhihu.com/people/jie-jie-44-85/activities']
    ...
    def parse_user_info(self, response):
        ...
        name = response.xpath(
            "//*[@class='title-section']/span/text() | //*[@class='title-section']/a/text()").extract_first()
        ...
        try:
            ...
            followees_num, followers_num = tuple(
                response.xpath("//div[@class='Profile-followStatusValue']/text()").extract())
